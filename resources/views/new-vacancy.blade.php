...
@section('title')
    <title>Nova vaga - Vagas Maceió</title>
@endsection
@section('css')
    <style>
        input,
                            ...
                            <div class="col-lg-auto">
                                <div class="d-flex gap-3 align-items-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20"
                                        fill="currentColor" data-bs-toggle="tooltip" data-bs-title="Destaque: sua vaga aparecerá no topo do site com um selo. Só será possível mudar seu plano em caso de renovação."
                                    ...
                                    <div class="form-floating order-1 order-lg-2 mb-3 w-100">
                                        <select class="form-select border-secondary rounded-0 fs-15" id="choiced_plan"
                                            ...
                                            <option value="Destaque"
                                                {{ old('choiced_plan') === 'Destaque' ? 'selected' : '' }}>
                                                Destaque (15 dias) — R$ 79,90
                                            </option>
                                            <option value="Normal"
                                                {{ old('choiced_plan') === 'Normal' ? 'selected' : '' }}>
                        ...
                        <div class="row mt-lg-5">
                                ...
                                <div class="d-flex flex-column gap-lg-3 justify-content-between justify-content-lg-start">
                                    ...
                                    <div class="form-floating hour_receive_email mt-3"
                                        ...
                                        <select class="form-select border-secondary rounded-0 fs-15"
                                            ...
                                            <option value="00:00" {{old('hour_receive_email') == '00:00' ? 'selected' : '' }}>00:00</option>
                                            <option value="00:30" {{old('hour_receive_email') == '00:30' ? 'selected' : '' }}>00:30</option>
                                            <option value="01:00" {{old('hour_receive_email') == '01:00' ? 'selected' : '' }}>01:00</option>
                                            <option value="01:30" {{old('hour_receive_email') == '01:30' ? 'selected' : '' }}>01:30</option>
                                            <option value="02:00" {{old('hour_receive_email') == '02:00' ? 'selected' : '' }}>02:00</option>
                                            <option value="02:30" {{old('hour_receive_email') == '02:30' ? 'selected' : '' }}>02:30</option>
                                            <option value="03:00" {{old('hour_receive_email') == '03:00' ? 'selected' : '' }}>03:00</option>
                                            <option value="03:30" {{old('hour_receive_email') == '03:30' ? 'selected' : '' }}>03:30</option>
                                            <option value="04:00" {{old('hour_receive_email') == '04:00' ? 'selected' : '' }}>04:00</option>
                                            <option value="04:30" {{old('hour_receive_email') == '04:30' ? 'selected' : '' }}>04:30</option>
                                            <option value="05:00" {{old('hour_receive_email') == '05:00' ? 'selected' : '' }}>05:00</option>
                                            <option value="05:30" {{old('hour_receive_email') == '05:30' ? 'selected' : '' }}>05:30</option>
                                            <option value="06:00" {{old('hour_receive_email') == '06:00' ? 'selected' : '' }}>06:00</option>
                                            <option value="06:30" {{old('hour_receive_email') == '06:30' ? 'selected' : '' }}>06:30</option>
                                            <option value="07:00" {{old('hour_receive_email') == '07:00' ? 'selected' : '' }}>07:00</option>
                                            <option value="07:30" {{old('hour_receive_email') == '07:30' ? 'selected' : '' }}>07:30</option>
                                            <option value="08:00" {{old('hour_receive_email') == '08:00' ? 'selected' : '' }}>08:00</option>
                                            <option value="08:30" {{old('hour_receive_email') == '08:30' ? 'selected' : '' }}>08:30</option>
                                            <option value="09:00" {{old('hour_receive_email') == '09:00' ? 'selected' : (!old('hour_receive_email') ? 'selected' : '') }}>09:00</option>
                                            <option value="09:30" {{old('hour_receive_email') == '09:30' ? 'selected' : '' }}>09:30</option>
                                            <option value="10:00" {{old('hour_receive_email') == '10:00' ? 'selected' : '' }}>10:00</option>
                                            <option value="10:30" {{old('hour_receive_email') == '10:30' ? 'selected' : '' }}>10:30</option>
                                            <option value="11:00" {{old('hour_receive_email') == '11:00' ? 'selected' : '' }}>11:00</option>
                                            <option value="11:30" {{old('hour_receive_email') == '11:30' ? 'selected' : '' }}>11:30</option>
                                            <option value="12:00" {{old('hour_receive_email') == '12:00' ? 'selected' : '' }}>12:00</option>
                                            <option value="12:30" {{old('hour_receive_email') == '12:30' ? 'selected' : '' }}>12:30</option>
                                            <option value="13:00" {{old('hour_receive_email') == '13:00' ? 'selected' : '' }}>13:00</option>
                                            <option value="13:30" {{old('hour_receive_email') == '13:30' ? 'selected' : '' }}>13:30</option>
                                            <option value="14:00" {{old('hour_receive_email') == '14:00' ? 'selected' : '' }}>14:00</option>
                                            <option value="14:30" {{old('hour_receive_email') == '14:30' ? 'selected' : '' }}>14:30</option>
                                            <option value="15:00" {{old('hour_receive_email') == '15:00' ? 'selected' : '' }}>15:00</option>
                                            <option value="15:30" {{old('hour_receive_email') == '15:30' ? 'selected' : '' }}>15:30</option>
                                            <option value="16:00" {{old('hour_receive_email') == '16:00' ? 'selected' : '' }}>16:00</option>
                                            <option value="16:30" {{old('hour_receive_email') == '16:30' ? 'selected' : '' }}>16:30</option>
                                            <option value="17:00" {{old('hour_receive_email') == '17:00' ? 'selected' : '' }}>17:00</option>
                                            <option value="17:30" {{old('hour_receive_email') == '17:30' ? 'selected' : '' }}>17:30</option>
                                            <option value="18:00" {{old('hour_receive_email') == '18:00' ? 'selected' : '' }}>18:00</option>
                                            <option value="18:30" {{old('hour_receive_email') == '18:30' ? 'selected' : '' }}>18:30</option>
                                            <option value="19:00" {{old('hour_receive_email') == '19:00' ? 'selected' : '' }}>19:00</option>
                                            <option value="19:30" {{old('hour_receive_email') == '19:30' ? 'selected' : '' }}>19:30</option>
                                            <option value="20:00" {{old('hour_receive_email') == '20:00' ? 'selected' : '' }}>20:00</option>
                                            <option value="20:30" {{old('hour_receive_email') == '20:30' ? 'selected' : '' }}>20:30</option>
                                            <option value="21:00" {{old('hour_receive_email') == '21:00' ? 'selected' : '' }}>21:00</option>
                                            <option value="21:30" {{old('hour_receive_email') == '21:30' ? 'selected' : '' }}>21:30</option>
                                            <option value="22:00" {{old('hour_receive_email') == '22:00' ? 'selected' : '' }}>22:00</option>
                                            <option value="22:30" {{old('hour_receive_email') == '22:30' ? 'selected' : '' }}>22:30</option>
                                            <option value="23:00" {{old('hour_receive_email') == '23:00' ? 'selected' : '' }}>23:00</option>
                                            <option value="23:30" {{old('hour_receive_email') == '23:30' ? 'selected' : '' }}>23:30</option>
                                        </select>
                            ...
                            <div class="col-12 mb-3 mb-lg-0 col-lg-3 text-lg-center">
                                <div class="d-flex flex-column gap-lg-3 justify-content-between justify-content-lg-start">
                                    ...
                                    <div class="form-floating max_candidates mt-3" style="display: none;">
                                        <input type="number" class="form-control border-secondary rounded-0 fs-15"
