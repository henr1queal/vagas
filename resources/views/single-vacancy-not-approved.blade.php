...
@section('title')
    <title>Vaga não aprovadas - Vagas Maceió</title>
@endsection
@section('css')
    <style>
        .bg-orange {
                        ...
                        <li
                            ...
                            <div class="ms-2 me-auto order-3 order-lg-2">
                                ...
                                <div class="d-flex flex-row gap-3 gap-lg-3 mt-3 mt-lg-0">
                                    ...
                                    <hr class="vr my-0 px-0 h-75 align-self-center opacity-75" style="width: 1px;">
                                    <div>
                                        <form action="{{ route('vacancy.approve', ['vacancy' => $vacancy]) }}" method="POST">
                                            @method('PUT')
                                            @csrf
                                            <button type="submit" class="border-0 bg-transparent text-decoration-underline" style="color: rgb(13, 110, 253);">Aprovar</button>
                                        </form>
                                        {{-- <a target="_blank"
