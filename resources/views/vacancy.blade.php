                ...
                <div class="d-flex flex-column gap-5">
                    <div class="d-flex flex-row justify-content-center gap-4 align-items-center">
                        ...
                        <div class="top-desc d-flex flex-column gap-2 text-center w-100">
                            <h1 class="title montserrat fs-24 mb-lg-0"><strong>{{ $vacancy->title }}</strong></h1>
                            <h2 class="fs-19 montserrat text-black d-lg-none"><strong>Detalhes sobre a vaga:</strong></h2>
                        </div>
                    </div>
                    <div class="d-flex flex-column gap-3">
                        ...
                        <div>
                            <h3 class="montserrat fs-18 text-black"><strong>Descrição da vaga:</strong></h3>
