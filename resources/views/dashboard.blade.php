                        ...
                        <div class="col-lg-6">
                            <div class="d-flex gap-3 align-items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor"
                                    data-bs-toggle="tooltip" data-bs-title="Ex: Enfermeiro(a)"
                                ...
                                <div class="form-floating w-100 order-1 order-lg-2 mb-3">
                                    <input type="text" class="form-control border-secondary rounded-0 fs-15"
                                        id="password" placeholder="Título da vaga" name="password" required>
                            ...
                            <div class="d-flex gap-3 align-items-center pb-3">
                                ...
                                <div class="form-floating w-100 order-1 order-lg-2">
                                    <input type="number" class="form-control border-secondary rounded-0 fs-15"
                                        id="workload" placeholder="Carga horária" name="workload" required>
                    ...
                    <div class="row mt-lg-5">
                        <div class="col-12 col-lg-auto text-lg-center col-xl-5">
                            <div class="d-flex flex-column gap-lg-3 justify-content-between justify-content-lg-start">
                                ...
                                <div class="form-floating hour_receive_email mt-3" style="display: none;">
                                    <select class="form-select border-secondary rounded-0 fs-15" id="hour_receive_email"
                                        aria-label="Horário">
                                    ...
                                    <label class="fs-15 text-black" for="hour_receive_email">Horário</label>
                                    <div class="invalid-feedback fs-14">
                                        Insira um horário.
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mb-3 mb-lg-0 col-lg-3 text-lg-center">
                            <div class="d-flex flex-column gap-lg-3 justify-content-between justify-content-lg-start">
                                ...
                                <div class="form-floating number_limit_candidates mt-3" style="display: none;">
                                    <input type="number" class="form-control border-secondary rounded-0 fs-15"
                                        id="number_limit_candidates" placeholder="Limite" name="number_limit_candidates"
                                        required>
                                    <label class="fs-15 text-black" for="number_limit_candidates">Limite</label>
                                    <div class="invalid-feedback fs-14">
                                        Insira um valor.
                                    </div>
                                </div>
                        ...
                        <div class="col-12 mb-3 mb-lg-0 col-lg-4 text-lg-center">
                            <div class="d-flex flex-column gap-lg-3 justify-content-between justify-content-lg-start">
                                ...
                                <div class="form-floating notifications_views mt-3" style="display: none;">
                                    <input type="number" class="form-control border-secondary rounded-0 fs-15"
                                        id="notifications_views" placeholder="Quantidade" name="notifications_views">
                                    <label class="fs-15 text-black" for="notifications_views">Quantidade</label>
                                    <div class="invalid-feedback fs-14">
                                        Insira um valor.
                                    </div>
                                </div>
